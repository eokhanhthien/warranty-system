...
class HrmController extends Controller
{
    ...
    {
        $users = Staff::where('business_id', Auth::user()->business_id)->get();
       // Thêm address
        ...
        return view('admin.HRM.index',compact('users','provinces','wards','districts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.HRM.edit',compact('id','provinces', 'wards', 'districts','user'));
    }
