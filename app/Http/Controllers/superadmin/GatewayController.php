...
class GatewayController extends Controller
{
    ...
    {
        $transfergateway =  TransferGateway::where('business_id', null)->first();
        return view('superadmin.gateway.index',compact('transfergateway'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $isGateway = TransferGateway::where('business_id', null)->first();
        ...
        if (!empty($isGateway)) {
            ...
            $transfergateway->business_id = null;
