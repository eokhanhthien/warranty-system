        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto">
                    <a href="{{ route('seller.business', ['domain' => request()->segment(2), 'category_slug' => request()->segment(3)]) }}" class="{{ str_starts_with(request()->url(), url('artisq/' . request()->segment(2) . '/' . request()->segment(3))) && url()->current() === url('artisq/' . request()->segment(2) . '/' . request()->segment(3)) ? 'nav-item nav-link active' : 'nav-item nav-link' }}">Home</a>
                    <a href="{{ route('seller.business.about', ['domain' => request()->segment(2), 'category_slug' => request()->segment(3)]) }}" class="{{ str_starts_with(request()->url(), url('artisq/' . request()->segment(2) . '/' . request()->segment(3) . '/about')) && url()->current() === url('artisq/' . request()->segment(2) . '/' . request()->segment(3). '/about') ? 'nav-item nav-link active' : 'nav-item nav-link' }}">About</a>
