...
<link href="{{ asset('assets/manager_web/css/style_all_product.css') }}" rel="stylesheet">
  ...
  @if(!empty($display_information->image))
    ...
    <div class="container-fluid page-header mb-5 py-5">
         <img src="https://cdn.mos.cms.futurecdn.net/yY8mi7JgYkdx6Lt3WWii8b.jpg" alt="" style ="width: 100%; height: 300px; object-fit: cover;" >
    </div>
    @endif
    <!-- Page Header End -->
    <!-- Service Start -->
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-3 " data-wow-delay="0.1s">
                    ...
                    <div class="filter-options">
                        <div for="sort_by">Sắp xếp theo:</div>
                        <select class="custom-select" id="sort_by" name="sort_by" style="padding: 2px; outline: none;display: none;">
