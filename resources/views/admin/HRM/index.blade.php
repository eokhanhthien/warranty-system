...
<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
                      ...
                      <tr>
                        ...
                        <td>{{ $user->role }}</td>
                          ...
                          <td>
                              @if ($user->last_login)
                                  ...
                                  ?>
                                  <span class="badge bg-label-primary me-1">{{ $lastLogin->format('d/m/Y') }}</span>
                              @else
                        ...
                        <td>
                          <button class="btn btn-primary btn-pd">
                            <a style="color: white" class="d-inline-block" href="{{route('hrm.edit',[$user->id])}}">
                              ...
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>                                          <form action="{{ route('hrm.destroy', ['id' => $user->id]) }}" method="POST" style="display: inline-block;">
                                              @csrf
                                              @method('DELETE')
                ...
                <!-- Modal -->
            <form action="{{ route('hrm.store') }}" method="POST" id="form-team" enctype="multipart/form-data">
              @csrf
